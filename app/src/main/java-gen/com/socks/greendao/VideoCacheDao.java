...
public class VideoCacheDao extends AbstractDao<VideoCache, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, VideoCache entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, VideoCache entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(VideoCache entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(VideoCache entity) {

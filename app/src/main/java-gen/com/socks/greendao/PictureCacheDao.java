...
public class PictureCacheDao extends AbstractDao<PictureCache, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, PictureCache entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, PictureCache entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(PictureCache entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(PictureCache entity) {

...
public class JokeCacheDao extends AbstractDao<JokeCache, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, JokeCache entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, JokeCache entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(JokeCache entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(JokeCache entity) {
